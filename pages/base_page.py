...
class Page:
    ...
    def verify_partial_url(self, expected_partail_url):
        current_url = self.driver.current_url
        assert expected_partail_url in current_url, \
            f"Expected partial URL {expected_partail_url} not in {current_url}"